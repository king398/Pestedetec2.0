...
for i in tqdm(range(5)):
    ...
    os.makedirs('/home/mithil/PycharmProjects/Pestedetec2.0/data/dataset/fold_{}/images/'.format(i), exist_ok=True)
    ...
    for j in tqdm(val_df['image_id'].unique()):
        shutil.copy(f'/home/mithil/PycharmProjects/Pestedetec2.0/data/images/{j}',
                    f'/home/mithil/PycharmProjects/Pestedetec2.0/data/dataset/fold_{i}/images')
        if os.path.exists(f'/home/mithil/PycharmProjects/Pestedetec2.0/data/labels/{j.split(".")[0]}.txt'):
            shutil.copy(f'/home/mithil/PycharmProjects/Pestedetec2.0/data/labels/{j.split(".")[0]}.txt',
                        f'/home/mithil/PycharmProjects/Pestedetec2.0/data/dataset/fold_{i}/labels')
