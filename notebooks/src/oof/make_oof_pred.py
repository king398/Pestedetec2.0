...
save_path = "/home/mithil/PycharmProjects/Pestedetec2.0/oof_raw_preds/mskf/yolov5m6-2000-image-size-mskf"
for i in range(5):
    os.system(
        f"python detect.py --weights /home/mithil/PycharmProjects/Pestedetec2.0/models/mskf/yolov5m6-2000-image-size-mskf/yolov5m6-2000-image-size-fold-{i}-25-epoch-mskf/weights/best.pt "

        f"--img-size 2000 --half "
