...
def make_labels(id):
    ...
    pbw = int(np.average(pbw_list) * 0.4 + np.average(pbw_list_2) * 0.6)
    abw = int(np.average(abw_list) * 0.4 + np.average(abw_list_2) * 0.6)
...
submission.to_csv(
    '/home/mithil/PycharmProjects/Pestedetec2.0/pred_df/2-54-mskf-yolov5-m-1536-20-25-epoch.csv',
    index=False)
